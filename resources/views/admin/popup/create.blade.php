<div class="modal fade" id="kt_modal_add_popup" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_popup_header">
            ...
            <form id="myForm" action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_popup_scroll" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_popup_header" data-kt-scroll-wrappers="#kt_modal_add_popup_scroll" data-kt-scroll-offset="800px">

                        <input type="hidden" class="form-control" id="id_popup"/>
                        
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">{{ __('Judul') }}</label>
                            <input type="text" class="form-control" placeholder="Judul Pop Up" name="title" id="title" />
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <b class="text-muted" style="font-size: 12px;">Ukuran gambar 1938 x 1028 pixel. Format gambar yang diperbolehkan: .jpg, .jpeg, .png</b>
