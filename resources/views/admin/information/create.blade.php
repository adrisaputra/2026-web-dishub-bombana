...
<div class="modal fade" id="kt_modal_add_information" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_information_header">
            ...
            <form id="myForm" action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_information_scroll" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_information_header" data-kt-scroll-wrappers="#kt_modal_add_information_scroll" data-kt-scroll-offset="800px">
                        
                        <input type="hidden" class="form-control" id="id_information"/>
...
<script>
    ...
    CKEDITOR.replace('text', {
        filebrowserUploadUrl: "{{route('upload_information', ['_token' => csrf_token() ])}}",
    ...
    $('#kt_modal_add_information').on('shown.bs.modal', function() {
