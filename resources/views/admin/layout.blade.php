...
<head>
	...
	<div id="loading">
		<div class="loading-content">
			<img src="{{ asset('storage/loading2.gif') }}" alt="Loading">
			<p>Loading...</p>
		</div>
	</div>
</head>
	...
	<div class="d-flex flex-column flex-root">
				...
				<div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
					...
					<div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
						...
						<div class="symbol symbol-50px">
							@if (Auth::user()->photo)
							<img src="{{ asset('storage/upload/user/' . Auth::user()->photo) }}" alt="">
							@else
							<img src="{{ asset('storage/profile-1-20210205190338.jpg') }}" alt="">
							@endif
						</div>
						<!--end::Symbol-->
						<!--begin::Wrapper-->
						<div class="aside-user-info flex-row-fluid flex-wrap ms-5">
							...
							<div class="d-flex">
								...
								<div class="flex-grow-1 me-2">
									<!--begin::Username-->
									<a href="#" class="text-hover-primary fs-6 fw-bold">{{ Auth::user()->name }}</a>
									<!--end::Username-->
									<!--begin::Description-->
								...
								<div class="me-n2">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													@if (Auth::user()->photo)
													<img src="{{ asset('storage/upload/user/' . Auth::user()->photo) }}" alt="Logo">
													@else
													<img src="{{ asset('storage/profile-1-20210205190338.jpg') }}" alt="Logo">
													@endif
												</div>
												<!--end::Avatar-->
												<!--begin::Username-->
										...
										<div class="menu-item px-5">
											<a href="{{ url('edit_profil/'.Crypt::encrypt(Auth::user()->id)) }}" class="menu-link px-5">Profile Saya</a>
										</div>
				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link @if(Request::segment(1)=="dashboard") active @endif" href="{{ url('/dashboard') }}" wire:navigate>
									<span class="menu-icon" style="margin-right: 15px">
										<img src="{{ asset('storage/menu/icons8-dashboard-layout-100.png') }}" width="30" height="30">
									</span>
									<span class="menu-title">Dashboard</span>
								</a>
							</div>

							<div data-kt-menu-trigger="click" class="menu-item @if(in_array(Request::segment(1), array('slider','popup'))) here show @endif menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									...
									<div class="menu-item">
										<a class="menu-link @if(Request::segment(1)=='popup') active @endif" href="{{ url('popup') }}">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Pop Up</span>
										</a>
									</div>
								</div>
							</div>
		...
		<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
			...
			<div id="kt_header" style="" class="header align-items-stretch">
				<!--begin::Brand-->
				<div class="header-brand" style="background: linear-gradient(135deg, #0D47A1 0%, #1976D2 50%, #2196F3 100%);">
					<!--begin::Logo-->
				...
				<!--end::Brand-->
				<div class="toolbar" style="background: linear-gradient(135deg, #2196F3 0%, #1976D2 50%, #0D47A1 100%);">
					<!--begin::Toolbar-->
					<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
						{{--<img alt="Logo" src="{{ asset('upload/setting/'.$setting->large_icon) }}" height="80%" width="300px">--}}
						{{--<img src="https://satudata.bombanakab.go.id/storage/upload/setting/11742382793.png" style="width:70px" />--}}
						<h2 class="font-weight-bolder text-white font-size-h2 font-size-h1-lg">{{ $setting->application_name }}</h2>
					</div>
					<!--end::Toolbar-->
				</div>
			</div>
			...
			<!--begin::Footer-->
			<div class="footer py-4 d-flex flex-lg-column" id="kt_footer" style="background: linear-gradient(135deg, #2196F3 0%, #1976D2 50%, #0D47A1 100%);">
				<!--begin::Container-->
				<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
					<!--begin::Copyright-->
					<div class="text-dark order-2 order-md-1">
						<span class="text-white fw-bold me-1">{{ date('Y') }}©</span>
