                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-information-table-toolbar="base">
                            ...
                            <a class="btn btn-success btn-sm me-2 mb-2" data-bs-toggle="modal" data-bs-target="#kt_modal_add_information" onClick="clearForm()"><i class="fa fa-plus"></i>Tambah {{ __($title)}}</a>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#information-table').DataTable({
            ...
            serverSide: true,
			ajax: {
				url: "{{ route('information.list', ['category' => $category ]) }}",
				type: 'GET',
				dataType: 'json',
			},
            columns: [
    ...
    function getData(id){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var coverLink = '<br><a href="{{ asset("storage/upload/information/") }}/' + response.data.cover + '" class="btn mb-2 mr-1 btn-sm btn-info snackbar-bg-info" target="_blank">Lihat Cover Sebelumnya</a>';
